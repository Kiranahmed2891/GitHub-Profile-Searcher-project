...
export default function GitHubProfileViewer() {
  ...
  const fetchUserData = async (): Promise<void> => {
    ...
    try {
      ...
      // Type assertion for 'error' to treat it as an Error object
  ...
  return (
    <div>
      <h1 className="items-center text-center font-bold text-5xl bg-lime-300">
        created by Kiran Ahmed
      </h1>
      <div className="flex flex-col items-center justify-center min-h-screen bg-lime-400 py-8">
        <Card className="w-full max-w-3xl p-6 space-y-4 shadow-lg  bg-white rounded-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-gray-600">
              ...
              repositories, search like: <span className="font-bold"> Kiranahmed2891</span>
            </CardDescription>
          </CardHeader>
